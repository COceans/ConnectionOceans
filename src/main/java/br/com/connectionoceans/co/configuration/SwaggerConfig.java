package br.com.connectionoceans.co.configuration;
...
public class SwaggerConfig {
	...
	public Docket api() {
		...
		.basePackage("br.com.connectionoceans.co.controller"))
	...
	public static ApiInfo metadata() {
		...
		return new ApiInfoBuilder()
			.title("API - Oceans Connection")
			.description("Projeto API Spring - Oceans Connections")
			.version("1.0.0")
			.license("Apache License Version 2.0")
			.licenseUrl("https://github.com/COceans")
			.contact(contact())
			.build();
	}
	...
	private static Contact contact() {
		...
		return new Contact("Oceans Connections", 
			"https://github.com/COceans", 
			"g04t31@gmail.com");
